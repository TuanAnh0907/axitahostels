(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ($(window).width() < 992) {
            $('.ah-drop-menu').parent('li').addClass('ah-dropdown');
        }
        $(window).resize(function () {
            if ($(window).width() < 992) {
                $('.ah-drop-menu').parent('li').addClass('ah-dropdown');
            } else {
                $('.ah-drop-menu').parent('li').removeClass('ah-dropdown');
            }
        });
        $(".ah-dropdown > a").on("click", function (e) {
            e.preventDefault();
            $('.ah-dropdown').removeClass('active-ah');
            $(this).parent('li').addClass('active-ah');
            if (!$(this).parent("li").parent("ul").hasClass("open")) {
                $(".main-navbar li").find('.open').removeClass('open');
            }
            $(this).next(".ah-drop-menu").addClass('open');
        });
        $(function () {
